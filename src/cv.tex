% TODO:
% 1. Split this file into sections?
...
\includegraphics{../assets/logo-crop}
\end{tabular}
...
\whatwherewhen{Senior Applied Scientist}{\href{https://www.microsoft.com/}{Microsoft}}{May 2018 \textendash{} June 2025}
...
\item \href{https://www.microsoft.com/en-gb/microsoft-copilot/organizations}{Microsoft 365 Copilot} and \href{https://learn.microsoft.com/en-us/graph/search-concept-person}{People Search}:
  ...
  \item Enhanced the quality semantic (natural language) search for people/contacts in \href{https://www.microsoft.com/en-us/microsoft-365/copilot}{Microsoft 365 Copilot}. Performed evaluation of embedding models, cross encoders and other retrieval techniques, leveraging LLM-based assessments and synthetic data generation (NDCG@10 up 5.3\% to 19.1\%, PR@10 up 5.8\% to 15.7\% depending on the setup, offline dataset, comparing to previous solution). (\textsc{LLMs}, \textsc{ChatGPT}, \textsc{RAG})

% Comparison with previous model:
% |              | PR@10   | NDCG@10 |
% | OpenAI       | 0.157   | 0.191   |
% | FBV          | 0.058   | 0.053   |
% | FBV + Rerank | 0.120   | 0.152   |
